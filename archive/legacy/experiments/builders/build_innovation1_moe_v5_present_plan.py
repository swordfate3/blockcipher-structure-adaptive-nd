...
MODELS = [
    ...
    },
    {
        ...
        "architecture_rank": 2,
        "score": 40,
        "evidence": "Best current SPN-specific token mixer expert",
    ...
    {
        "network": "MoE-v5-Hard",
        "model_key": "moe_v5_hard",
        "family": "structure_expert_moe",
        "architecture_rank": 4,
        "score": 38,
        "evidence": "Structure expert MoE with fixed SPN TokenMixer prior",
    ...
    },
    {
        ...
        "architecture_rank": 0,
        "score": 42,
        "evidence": "Trainable structure expert MoE including SPN TokenMixer",
        "literature": "Innovation-one structure-expert MoE v5",
    },
]
...
def main() -> None:
    output = Path("experiments/plans/innovation1_moe_v5_present.csv")
