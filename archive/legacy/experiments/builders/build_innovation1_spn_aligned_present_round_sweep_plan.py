                ...
                rows.append(
                    {
                        ...
                        "difference_member": 0,
                        "evidence": "Round-sweep validation for inverse-P aligned SPN inputs",
                        "literature": "Innovation-one SPN aligned input and token mixer validation",
                    }
                )
    return rows
...
def main() -> None:
    output = Path("experiments/plans/innovation1_spn_aligned_present_round_sweep.csv")
