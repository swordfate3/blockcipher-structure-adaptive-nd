...
MODELS = [
    ...
    },
    {
        ...
        "architecture_rank": 4,
        "score": 50,
        "evidence": "Fixed single-seed HPO trial 20 configuration",
        "literature": "Innovation-one MoE v5 component HPO",
    },
    {
        "network": "MoE-v5-Soft-HPO-MultiSeed-Trial11",
        "model_key": "moe_v5_soft_hpo_multiseed_present_best",
        "family": "structure_expert_moe_hpo_multiseed_fixed",
        "architecture_rank": 0,
        "score": 60,
        "evidence": "Fixed multi-seed HPO trial 11 configuration",
        "literature": "Innovation-one MoE v5 multi-seed component HPO",
    },
]
...
def main() -> None:
    output = Path("experiments/plans/innovation1_moe_v5_hpo_multiseed_best_validate_present.csv")
