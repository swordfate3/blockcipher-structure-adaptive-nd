...
set BRANCH=main
set RUN_ID=innovation1-spn-pairset-v2-present-gpu1-20260605
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\plans\innovation1_spn_pairset_v2_present.csv ^
  --epochs 10 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
echo plan=experiments\plans\innovation1_spn_pairset_v2_present.csv>> results_archive\%RUN_ID%\run_manifest.txt
