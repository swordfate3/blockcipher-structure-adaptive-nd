...
set BRANCH=main
set RUN_ID=innovation1-moe-v5-hpo-multiseed-best-validate-present-gpu1-20260606
set EXPECTED_ROWS=25
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\plans\innovation1_moe_v5_hpo_multiseed_best_validate_present.csv ^
  --epochs 10 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy experiments\plans\innovation1_moe_v5_hpo_multiseed_best_validate_present.csv results_archive\%RUN_ID%\
...
echo plan=experiments\plans\innovation1_moe_v5_hpo_multiseed_best_validate_present.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo fixed_hpo_model=moe_v5_soft_hpo_multiseed_present_best>> results_archive\%RUN_ID%\run_manifest.txt
echo fixed_hpo_source=innovation1-moe-v5-hpo-multiseed-present-gpu1-20260606 trial 11>> results_archive\%RUN_ID%\run_manifest.txt
