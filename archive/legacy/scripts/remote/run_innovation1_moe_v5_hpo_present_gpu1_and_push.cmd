...
set BRANCH=main
set RUN_ID=innovation1-moe-v5-hpo-present-gpu1-20260606
...
echo max_trials=24>> results_archive\%RUN_ID%\run_manifest.txt
...
git commit -m "results: %RUN_ID% remote hpo run"
