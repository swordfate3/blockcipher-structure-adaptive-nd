...
set BRANCH=main
set RUN_ID=innovation1-moe-v5-present-gpu1-20260606
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\plans\innovation1_moe_v5_present.csv ^
  --epochs 10 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy experiments\plans\innovation1_moe_v5_present.csv results_archive\%RUN_ID%\
...
echo plan=experiments\plans\innovation1_moe_v5_present.csv>> results_archive\%RUN_ID%\run_manifest.txt
