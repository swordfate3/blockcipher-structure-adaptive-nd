...
set BRANCH=main
set RUN_ID=innovation1-structure-pairset-gpu0-20260605
set EXPECTED_ROWS=72
...
echo plan=experiments\plans\innovation1_structure_pairset_gpu0.csv>> results_archive\%RUN_ID%\run_manifest.txt
