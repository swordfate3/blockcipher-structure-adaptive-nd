...
set BRANCH=main
set RUN_ID=innovation1-structure-pairset-gpu1-20260605
set EXPECTED_ROWS=36
...
echo plan=experiments\plans\innovation1_structure_pairset_gpu1.csv>> results_archive\%RUN_ID%\run_manifest.txt
