                        ...
                        rows.append(
                            {
                                ...
                                "difference_member": 0,
                                "evidence": "Cross-key and negative-sample protocol stress test for SPN aligned input",
...
def main() -> None:
    output = Path("experiments/plans/innovation1_spn_crosskey_negative_present.csv")
