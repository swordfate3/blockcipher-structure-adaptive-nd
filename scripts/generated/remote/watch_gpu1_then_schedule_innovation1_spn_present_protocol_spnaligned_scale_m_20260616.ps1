...
$RunId = "innovation1-spn-present-protocol-spnaligned-scale-m-gpu1-20260616"
$GpuIndex = "1"
$ScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_protocol_spnaligned_scale_m_gpu1_20260616.cmd"
