...
start "progress_innovation1-spn-present-zhang-wang2022-keras-official-anchor-smoke-gpu1-20260621" cmd.exe /c powershell -NoProfile -ExecutionPolicy Bypass -Command "while ($true) { if (Test-Path 'G:\lxy\blockcipher-structure-adaptive-nd\scripts\tail_progress.py') { & 'F:\Anaconda\envs\DWT\torch310\python.exe' 'G:\lxy\blockcipher-structure-adaptive-nd\scripts\tail_progress.py' 'G:\lxy\blockcipher-structure-adaptive-nd-runs\innovation1-spn-present-zhang-wang2022-keras-official-anchor-smoke-gpu1-20260621\logs\innovation1-spn-present-zhang-wang2022-keras-official-anchor-smoke-gpu1-20260621_progress.jsonl' --interval 5 --exit-on-complete; break }; cls; Write-Host 'waiting for progress viewer G:\lxy\blockcipher-structure-adaptive-nd\scripts\tail_progress.py'; Start-Sleep -Seconds 2 }"
call G:\lxy\blockcipher-structure-adaptive-nd\scripts\generated\remote\run_innovation1-spn-present-zhang-wang2022-keras-official-anchor-smoke-gpu1-20260621_and_push.cmd > %LAUNCH_LOG_DIR%\%RUN_ID%_launcher_stdout.txt 2> %LAUNCH_LOG_DIR%\%RUN_ID%_launcher_stderr.txt
endlocal
