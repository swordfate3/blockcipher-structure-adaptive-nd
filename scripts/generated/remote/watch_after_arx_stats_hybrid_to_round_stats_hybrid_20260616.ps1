...
$UpstreamRun = "innovation1-arx-speck32-stats-hybrid-r7-screen-gpu1-20260616"
$NextRun = "innovation1-arx-speck32-round-stats-hybrid-r7-screen-gpu1-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_round_stats_hybrid_r7_screen_gpu1_20260616.cmd"
