...
$UpstreamRun = "innovation1-spn-present-spnaligned-r6-controls-10seed-gpu0-20260615"
$NextRun = "innovation1-arx-speck32-round-hybrid-rx-smoke-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_round_hybrid_rx_smoke_gpu0_20260616.cmd"
