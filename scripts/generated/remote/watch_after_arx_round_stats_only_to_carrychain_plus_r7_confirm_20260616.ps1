...
$UpstreamRun = "innovation1-arx-speck32-round-stats-only-r7-screen-gpu1-20260616"
$NextRun = "innovation1-arx-speck32-carrychain-plus-r7-confirm-4seed-gpu1-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_carrychain_plus_r7_confirm_4seed_gpu1_20260616.cmd"
