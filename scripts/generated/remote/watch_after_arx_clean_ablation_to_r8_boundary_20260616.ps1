...
$NextRun = "innovation1-arx-speck32-partial-inverse-r8-boundary-10seed-gpu1-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_partial_inverse_r8_boundary_10seed_gpu1_20260616.cmd"
