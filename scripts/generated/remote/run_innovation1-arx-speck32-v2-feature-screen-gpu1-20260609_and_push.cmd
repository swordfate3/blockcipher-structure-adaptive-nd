...
set EXPECTED_ROWS=32
set RUN_ROOT=%ROOT%\%PROJECT_ID%-runs
set RUN_DIR=%RUN_ROOT%\%RUN_ID%
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_v2_feature_screen_20260609
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_v2_feature_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_v2_feature_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=speck32_arx_v2_feature_screen>> results_archive\%RUN_ID%\run_manifest.txt
