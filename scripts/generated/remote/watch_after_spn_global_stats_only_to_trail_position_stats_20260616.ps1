...
$UpstreamRun = "innovation1-spn-present-global-stats-only-beamstats8deep4-r7-gpu0-20260616"
$NextRun = "innovation1-spn-present-trail-position-stats-r7r8-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_trail_position_stats_r7r8_gpu0_20260616.cmd"
