...
$UpstreamRun = "innovation1-spn-present-stats-hybrid-beamstats8deep4-r7-gpu0-20260616"
$NextRun = "innovation1-spn-present-histogram-hybrid-beamstats8deep4-r7-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_histogram_hybrid_beamstats8deep4_r7_gpu0_20260616.cmd"
