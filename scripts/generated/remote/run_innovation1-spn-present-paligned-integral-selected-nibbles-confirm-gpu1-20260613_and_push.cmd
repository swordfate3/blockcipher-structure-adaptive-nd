...
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_paligned_integral_selected_nibbles_confirm_gpu1_20260613
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_paligned_integral_selected_nibbles_confirm_gpu1.csv ^
  --epochs 12 ^
  --batch-size 512 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_paligned_integral_selected_nibbles_confirm_gpu1.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_paligned_integral_selected_nibbles_confirm_gpu1.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_spn_paligned_integral_selected_nibbles_confirm_gpu1>> results_archive\%RUN_ID%\run_manifest.txt
