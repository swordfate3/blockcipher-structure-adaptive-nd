...
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_v2_scale_smoke_20260611
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_arx_speck32_v2_scale_smoke.csv ^
  --epochs 1 ^
  --batch-size 512 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_v2_scale_smoke.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_v2_scale_smoke.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo epochs=1>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=speck32_arx_v2_scale_smoke>> results_archive\%RUN_ID%\run_manifest.txt
