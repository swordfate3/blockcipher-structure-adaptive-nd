...
$NextRun = "innovation1-spn-present-global-stats-only-beamstats8deep4-r7-gpu0-20260616"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_global_stats_only_beamstats8deep4_r7_gpu0_20260616.cmd"
$LogPath = Join-Path $LogDir "watch_gpu0_then_${NextRun}.log"
$PollSeconds = 600
$GpuIndex = 0
