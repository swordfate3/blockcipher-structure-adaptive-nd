...
$UpstreamRun = "innovation1-arx-speck32-round-hybrid-rx-smoke-gpu0-20260616"
$NextRun = "innovation1-arx-speck32-round-hybrid-rx-r7-confirm-10seed-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_round_hybrid_rx_r7_confirm_10seed_gpu0_20260616.cmd"
