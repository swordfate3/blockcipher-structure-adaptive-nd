...
$UpstreamRun = "innovation1-spn-present-sinv-curriculum-r7-gpu0-20260616"
$NextRun = "innovation1-spn-present-protocol-spnaligned-r7-confirm-5seed-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_protocol_spnaligned_r7_confirm_5seed_gpu0_20260616.cmd"
