...
$UpstreamRun = "innovation1-arx-speck32-carry-position-stats-r7r8-gpu1-20260616"
$NextRun = "innovation1-arx-speck32-carry-run-mixer-r7r8-gpu1-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_carry_run_mixer_r7r8_gpu1_20260616.cmd"
