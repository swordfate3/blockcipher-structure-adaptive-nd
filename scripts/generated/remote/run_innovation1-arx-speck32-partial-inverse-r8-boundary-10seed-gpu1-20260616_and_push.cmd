...
set RUN_ID=innovation1-arx-speck32-partial-inverse-r8-boundary-10seed-gpu1-20260616
set EXPECTED_ROWS=20
set RUN_ROOT=%ROOT%\%PROJECT_ID%-runs
set RUN_DIR=%RUN_ROOT%\%RUN_ID%
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_partial_inverse_r8_boundary_10seed_gpu1_20260616
...
%PY% experiments\run_innovation_one_matrix.py --plan experiments\innovation1\plans\innovation1_arx_speck32_partial_inverse_r8_boundary_10seed.csv --epochs 20 --batch-size 1024 --hidden-bits 64 --learning-rate 0.0001 --optimizer adamw --weight-decay 0.0001 --key-rotation-interval 1024 --sample-structure independent_pairs --integral-active-nibble 0 --device cuda:1 --dataset-cache-root dataset_cache --dataset-cache-chunk-size 8192 --checkpoint-metric val_auc --restore-best-checkpoint --early-stopping-patience 5 --early-stopping-min-delta 0 --progress-output logs\%RUN_ID%_progress.jsonl --output results\%RUN_ID%.jsonl > logs\%RUN_ID%_stdout.txt 2> logs\%RUN_ID%_stderr.txt
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_partial_inverse_r8_boundary_10seed.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_partial_inverse_r8_boundary_10seed.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo early_stopping_patience=5>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=arx_speck32_partial_inverse_r8_boundary_10seed_gpu1>> results_archive\%RUN_ID%\run_manifest.txt
