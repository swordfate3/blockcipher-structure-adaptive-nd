...
$NextRun = "innovation1-spn-present-delta-sinv-beam4deep3-r7-gpu1-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_delta_sinv_beam4deep3_r7_gpu1_20260616.cmd"
