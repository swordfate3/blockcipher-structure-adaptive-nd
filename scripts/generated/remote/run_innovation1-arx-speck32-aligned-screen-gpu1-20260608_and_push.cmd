...
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_aligned_screen_20260608
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_arx_speck32_aligned_screen.csv ^
  --epochs 8 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_aligned_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_aligned_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=speck32_arx_aligned_screen>> results_archive\%RUN_ID%\run_manifest.txt
