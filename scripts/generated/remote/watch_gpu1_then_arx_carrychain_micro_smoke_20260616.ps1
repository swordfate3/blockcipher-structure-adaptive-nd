...
$RunId = "innovation1-arx-speck32-carrychain-micro-smoke-gpu1-20260616"
$GpuIndex = "1"
$ScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_carrychain_micro_smoke_gpu1_20260616.cmd"
