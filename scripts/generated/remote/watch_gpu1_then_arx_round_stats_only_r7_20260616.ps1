...
$NextRun = "innovation1-arx-speck32-round-stats-only-r7-screen-gpu1-20260616"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_arx_speck32_round_stats_only_r7_screen_gpu1_20260616.cmd"
