...
set RUN_ID=innovation1-spn-present-stats-hybrid-beamstats8deep4-r7-gpu0-20260616
set EXPECTED_ROWS=4
set RUN_ROOT=%ROOT%\%PROJECT_ID%-runs
set RUN_DIR=%RUN_ROOT%\%RUN_ID%
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_stats_hybrid_beamstats8deep4_r7_gpu0_20260616
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_stats_hybrid_beamstats8deep4_r7_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_stats_hybrid_beamstats8deep4_r7_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=spn_present_stats_hybrid_beamstats8deep4_r7_gpu0>> results_archive\%RUN_ID%\run_manifest.txt
