...
set RUN_ID=innovation1-spn-present-entropy-selected-scale-s-gpu1-20260615
set EXPECTED_ROWS=6
set RUN_ROOT=%ROOT%\%PROJECT_ID%-runs
set RUN_DIR=%RUN_ROOT%\%RUN_ID%
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_entropy_selected_scale_s_gpu1_20260615
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_entropy_selected_scale_s.csv ^
  --epochs 50 ^
  --batch-size 4096 ^
  --hidden-bits 12 ^
  --learning-rate 0.0001 ^
  --optimizer adam ^
  --weight-decay 6.4e-07 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_entropy_selected_scale_s.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_entropy_selected_scale_s.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo batch_size=4096>> results_archive\%RUN_ID%\run_manifest.txt
echo hidden_bits=12>> results_archive\%RUN_ID%\run_manifest.txt
echo optimizer=adam>> results_archive\%RUN_ID%\run_manifest.txt
echo weight_decay=6.4e-07>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_entropy_selected_scale_s_protocol_gpu1>> results_archive\%RUN_ID%\run_manifest.txt
