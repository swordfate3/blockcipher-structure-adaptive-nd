...
set LAUNCHER_DIR=%RUN_ROOT%\launchers
if not exist %RUN_ROOT% mkdir %RUN_ROOT%
if not exist %LAUNCH_LOG_DIR% mkdir %LAUNCH_LOG_DIR%
call %LAUNCHER_DIR%\run_innovation1-spn-candidate-evidence-r7-65536-gpu0-20260623_and_push.cmd > %LAUNCH_LOG_DIR%\%RUN_ID%_launcher_stdout.txt 2> %LAUNCH_LOG_DIR%\%RUN_ID%_launcher_stderr.txt
endlocal
