...
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_round_hybrid_rx_r7_confirm_10seed_gpu0_20260616
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_arx_speck32_round_hybrid_rx_r7_confirm_10seed.csv ^
  --epochs 16 ^
  --batch-size 256 ^
  --hidden-bits 32 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_round_hybrid_rx_r7_confirm_10seed.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_round_hybrid_rx_r7_confirm_10seed.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo batch_size=256>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=arx_speck32_round_hybrid_rx_r7_confirm_10seed_gpu0>> results_archive\%RUN_ID%\run_manifest.txt
