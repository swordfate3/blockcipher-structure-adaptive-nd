...
$RunId = "innovation1-spn-present-delta-only-structural-r7-gpu0-20260616"
$GpuIndex = "0"
$ScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_delta_only_structural_r7_gpu0_20260616.cmd"
