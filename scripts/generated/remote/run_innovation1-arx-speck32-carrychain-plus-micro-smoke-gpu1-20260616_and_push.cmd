...
set ARCHIVE_WORK=%ROOT%\archive_work\arx_speck32_carrychain_plus_micro_smoke_gpu1_20260616
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_arx_speck32_carrychain_plus_micro_smoke.csv ^
  --epochs 6 ^
  --batch-size 128 ^
  --hidden-bits 32 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_arx_speck32_carrychain_plus_micro_smoke.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_arx_speck32_carrychain_plus_micro_smoke.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=arx_speck32_carrychain_plus_micro_smoke_gpu1>> results_archive\%RUN_ID%\run_manifest.txt
