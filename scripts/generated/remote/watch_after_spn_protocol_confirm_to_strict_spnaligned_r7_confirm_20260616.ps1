...
$UpstreamRun = "innovation1-spn-present-protocol-spnaligned-r7-confirm-5seed-gpu0-20260616"
$NextRun = "innovation1-spn-present-strict-spnaligned-r7-confirm-5seed-gpu0-20260616"
$UpstreamBranch = "results/$UpstreamRun"
$NextScheduleScript = Join-Path $ProjectPath "scripts\generated\remote\schedule_innovation1_spn_present_strict_spnaligned_r7_confirm_5seed_gpu0_20260616.cmd"
