...
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_multikey_k1024_screen_20260612
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_multikey_screen_k1024.csv ^
  --epochs 10 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_multikey_screen_k1024.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_multikey_screen_k1024.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_spn_multikey_k1024_screen>> results_archive\%RUN_ID%\run_manifest.txt
