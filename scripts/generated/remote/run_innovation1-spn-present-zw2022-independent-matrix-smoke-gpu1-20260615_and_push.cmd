...
set RUN_ID=innovation1-spn-present-zw2022-independent-matrix-smoke-gpu1-20260615
set EXPECTED_ROWS=2
set RUN_ROOT=%ROOT%\%PROJECT_ID%-runs
set RUN_DIR=%RUN_ROOT%\%RUN_ID%
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_zw2022_independent_matrix_smoke_gpu1_20260615
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_zhang_wang2022_independent_matrix_smoke.csv ^
  --epochs 20 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_zhang_wang2022_independent_matrix_smoke.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_zhang_wang2022_independent_matrix_smoke.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_zw2022_independent_matrix_smoke_protocol_gpu1>> results_archive\%RUN_ID%\run_manifest.txt
