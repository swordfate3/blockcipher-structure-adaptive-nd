...
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_highround_aligned_screen_20260612
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_highround_aligned_screen.csv ^
  --epochs 16 ^
  --batch-size 1024 ^
  --hidden-bits 96 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_highround_aligned_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_highround_aligned_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo hidden_bits=96>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_spn_highround_aligned_screen>> results_archive\%RUN_ID%\run_manifest.txt
