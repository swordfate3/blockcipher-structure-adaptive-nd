...
set ARCHIVE_WORK=%ROOT%\archive_work\spn_present_sboxddt_beam2_highround_screen_gpu0_20260615
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\innovation1\plans\innovation1_spn_present_sboxddt_beam2_highround_screen.csv ^
  --epochs 20 ^
  --batch-size 128 ^
  --hidden-bits 32 ^
...
copy "%RUN_DIR%\experiments\innovation1\plans\innovation1_spn_present_sboxddt_beam2_highround_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\innovation1\plans\innovation1_spn_present_sboxddt_beam2_highround_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo validation=present_sboxddt_beam2_highround_screen_gpu0>> results_archive\%RUN_ID%\run_manifest.txt
