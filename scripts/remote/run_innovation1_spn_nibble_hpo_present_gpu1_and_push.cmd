...
set BRANCH=main
set RUN_ID=innovation1-spn-nibble-hpo-present-gpu1-20260605
...
%PY% experiments\run_hparam_search.py ^
  --space experiments\hparam_spaces\spn_nibble_conv_pairset_present.json ^
  --mode random ^
  --max-trials 12 ^
  --seed 20260605 ^
...
copy experiments\hparam_spaces\spn_nibble_conv_pairset_present.json results_archive\%RUN_ID%\
...
echo space=experiments\hparam_spaces\spn_nibble_conv_pairset_present.json>> results_archive\%RUN_ID%\run_manifest.txt
...
echo samples_per_class=8192>> results_archive\%RUN_ID%\run_manifest.txt
echo epochs=3>> results_archive\%RUN_ID%\run_manifest.txt
...
git commit -m "results: %RUN_ID% remote hpo"
