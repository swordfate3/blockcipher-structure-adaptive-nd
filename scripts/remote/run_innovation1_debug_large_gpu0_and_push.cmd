...
set BRANCH=main
set RUN_ID=innovation1-debug-large-gpu0-20260604
set EXPECTED_ROWS=216
...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\plans\innovation1_debug_large_gpu0.csv ^
  --epochs 10 ^
  --batch-size 2048 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
echo plan=experiments\plans\innovation1_debug_large_gpu0.csv>> results_archive\%RUN_ID%\run_manifest.txt
...
echo batch_size=2048>> results_archive\%RUN_ID%\run_manifest.txt
