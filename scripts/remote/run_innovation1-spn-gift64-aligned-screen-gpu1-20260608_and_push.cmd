...
%PY% experiments\run_innovation_one_matrix.py ^
  --plan experiments\plans\innovation1_spn_gift64_aligned_screen.csv ^
  --epochs 8 ^
  --batch-size 1024 ^
  --hidden-bits 64 ^
  --learning-rate 0.001 ^
...
copy "%RUN_DIR%\experiments\plans\innovation1_spn_gift64_aligned_screen.csv" "results_archive\%RUN_ID%\"
...
echo plan=experiments\plans\innovation1_spn_gift64_aligned_screen.csv>> results_archive\%RUN_ID%\run_manifest.txt
